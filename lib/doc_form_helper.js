...
exports.makeSimpleDespatchList=function(doc){
	...
	switch(doc.despatchStatus){
		case 'Deleted': newDoc.despatchStatus +='invoice-declined">Silindi';break;
		case 'Draft': newDoc.despatchStatus +='invoice-draft">Taslak';break;
		case 'Pending': newDoc.despatchStatus +='invoice-pending">Gönderiliyor';break;
		case 'Kuyrukta': newDoc.despatchStatus +='invoice-processing">Kuyruğa alındı';break;
		...
		case 'PartialApproved':	newDoc.despatchStatus +='invoice-partial-approved">Kısmi Onaylandı';break;
		case 'Declined': newDoc.despatchStatus +='invoice-declined">Reddedildi'; break;
		case 'Canceled': newDoc.despatchStatus +='invoice-declined">İptal Edildi'; break;
		case 'WaitingForApprovement': newDoc.despatchStatus +='invoice-waitingforapprovement">Onay bekliyor';break;
