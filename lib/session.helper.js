exports.newSession=(loginData,req,res,cb)=>{
	...
	var yeniOturum={menu:[],dbId:'', dbName:'', mId:'', token:loginData.token,username:loginData.username,isSysUser:loginData.isSysUser,isMember: loginData.isMember, ip:IP,userAgent:userAgent,databases:databases}
