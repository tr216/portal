var orjinalInvoiceLineModal;

function editLine(index){
	var old=document.getElementById('invoiceLineModal');
	old.parentNode.replaceChild(orjinalInvoiceLineModal.cloneNode(true),old);
...
$(document).ready(function(){
	...
	orjinalInvoiceLineModal=document.getElementById('invoiceLineModal').cloneNode(true);
